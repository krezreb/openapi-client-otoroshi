...
class TargetsList(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """TargetsList - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] ([OtoroshiModelsTarget]):  # noqa: E501

        Keyword Args:
            value ([OtoroshiModelsTarget]):  # noqa: E501
